...
export interface DefinitionSummary { key:string; source:'builtin'|'custom'; model:string; manufacturer:string; description:string; category:string; default_address:number; default_update_interval:string; has_set_base:boolean; used_by:string[] }
