...
app.include_router(mqtt_topics_router)
...
from boneio.webui.routes import mqtt_topics as mqtt_topics_module
...
app.dependency_overrides[mqtt_topics_module.get_manager] = get_manager
